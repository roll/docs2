---
title: Data Curator - share usable open data
author: Joel Marcey
...
![Data Curator Logo](/img/data-curator/data-curator-logo-3.png)
...
Data Curator uses the [Frictionless Data specification](https://frictionlessdata.io/specs/) and [software](https://frictionlessdata.io/software/ "Frictionless Data platforms, applications, and software libraries") to package the data and supporting information in a [Tabular Data Package](https://frictionlessdata.io/specs/tabular-data-package/ "Tabular Data Package specification").

![Data Curator screenshot](/img/data-curator/data-curator.png)
...
The Frictionless Data specification allows you to describe tabular data using a [Table Schema](https://frictionlessdata.io/specs/table-schema/ "Table Schema specification").  A Table Schema allows each field in the data to be given:
...
![Add provenance information screenshot](/img/data-curator/data-curator-2.png)


You should follow the [Readme FAQ](https://frictionlessdata.io/docs/publish-faq/#readme "Publishing Data Packages - FAQ") when writing provenance information or, even easier, cut and paste from this [sample](https://github.com/ODIQueensland/data-curator/blob/develop/test/features/tools/sample-provenance-information.md "Sample Provenance Information Markdown file on GitHub").
...
We've implemented the [Foreign Keys to Data Packages pattern](https://frictionlessdata.io/specs/patterns/#table-schema:-foreign-keys-to-data-packages "The Foreign Keys to Data Packages pattern") so you can have foreign key relationships across two data packages. This is really useful if you want to share code-lists across organisations.
...
Data Curator lets you save data as a comma, semicolon, or tab separated value file. A matching [CSV Dialect](https://frictionlessdata.io/specs/csv-dialect/ "The CSV Dialect specification") is added to the data package.

### Apply an open license

Applying a license, waiver, or public domain mark to a [data package](https://frictionlessdata.io/specs/data-package/#licenses "The licenses property in the Data Package specification") and its [resources](https://frictionlessdata.io/specs/data-resource/#optional-properties "The licenses property in the Data Resource specification") helps people understand how they can use, modify, and share the contents of the data package.

![Apply open license to data package screenshot](/img/data-curator/data-curator-3.png)


Although there are many ways to [apply a licence, waiver or public domain mark](https://frictionlessdata.io/docs/applying-licenses/ "Guide to applying licenses, waivers or public domain marks to data packages") to a data package, Data Curator only allows you to use open licences - after all, its purpose is to share usable open data.
...
If a data package `version` is used, it must follow the [data package version pattern](https://frictionlessdata.io/specs/patterns/#data-package-version "Data Package Version pattern").
...
Open data consumers will be able to read the data package with one of the [many applications and software libraries that work with data packages](https://frictionlessdata.io/software/ "Frictionless Data platforms, applications, and software libraries"), including Data Curator.
...
Data Curator uses the [Frictionless Data software libraries](https://frictionlessdata.io/software/) maintained by [Open Knowledge International](https://okfn.org) and we're extremely grateful for the support provided by [the team](https://github.com/orgs/frictionlessdata/teams/core/members).
